<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster/StandardMaster.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="InAndOutReportView.aspx.cs" Inherits="Client.Site.Administrator.InAndOutReportView" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <telerik:RadGrid ID="rgReport" runat="server" AutoGenerateEditColumn="False" GridLines="None" Skin="Silk"
        OnPreRender="rgReport_PreRender" AllowSorting="True" AllowFilteringByColumn="true" AllowPaging="true" PageSize="20"
            ...
            <CommandItemTemplate>
                <div style="padding: 5px;">
                    <div style="float: left; margin-left: 10px">
                        <telerik:RadNumericTextBox ID="rtbInOutYear" runat="server" Label="Artikel Filter (Jahr)" MinValue="1900" MaxValue="2100" Type="Number" Width="300px" LabelWidth="160px"
                            OnTextChanged="rtbInOutYear_TextChanged" AutoPostBack="true">
                            <NumberFormat GroupSeparator="" DecimalDigits="0" />
                        </telerik:RadNumericTextBox>

                        <telerik:RadButton ID="rbtInOutFilter" runat="server" Text="Filtern" AutoPostBack="true" OnClick="rbtInOutFilter_Click"></telerik:RadButton>
                    </div>
                    <div style="float: left; margin-left: 10px">
